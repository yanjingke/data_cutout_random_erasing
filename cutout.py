...
if __name__ == '__main__':
    ...
    coords="70,24,110,65,118,53,157,95,185,38,220,73,253,28,298,69,217,88,268,132".split(",")
    coords = [[70,24,110,65]]
    # print(coords)
    print(coords)
    img = cv2.imread("I:/wangyi/wangyi_d/y/608a9a78-de2e-11ea-8203-d46d6dd6c1fc.jpg")
